...
Card preferences come first, followed by player name, language, and devices and
recovery. Guests see card preferences and language. The language selector shows
